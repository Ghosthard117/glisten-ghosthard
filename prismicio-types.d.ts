...
/**
 * Item in *CaseStudies → Default → Primary → Case Study Links*
 */
export interface CaseStudiesSliceDefaultPrimaryCaseStudyLinksItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → Case Study Links*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.case_study_links[].case_study
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * Case Study Links field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.case_study_links[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  case_study_links: prismic.GroupField<
    Simplify<CaseStudiesSliceDefaultPrimaryCaseStudyLinksItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      BentoSliceDefault,
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryCaseStudyLinksItem,
